                ...
                children: <Widget>[
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButtonFormField2<String>(
                        ...
                        onChanged: (value) async {
                          ...
                          print("Selected= "+selectedTypeImmatriculationValue.toString());
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text('Enregistrer',style: TextStyle(fontSize: 30),),
                      onPressed: () async {
                            ...
                            (voiturefullImmatController.text.isNotEmpty|| (leftImmatValue.isNotEmpty && rightImmatValue.isNotEmpty) ))
                        {
                          ...
                          /*voituresSeriesList.forEach((String serie){
                            if(ImmatValueToSave == serie){
                              ImmatExists=true;
                            }
                          });*/
                          if(ImmatExists){
                            ...
                            Future.delayed(const Duration(seconds: 1),() async {
                              ...
                              registerVoitures(ImgVoitureUrl!, selectedMakeValue!, selectedMakeYearValue!,
                                  ...
                                  ImmatValueToSave, selectedTypeCarburantValue!, voitureKilometrageController.text,
